...
public class JspServlet extends HttpServlet {
	...
	private String mutexStudentDao = "1";
	private String mutexSubjectDao = "2";
	private String mutexMarkDao = "3";
	...
	private void updateSubject(HttpServletRequest req, HttpServletResponse resp) throws DaoException, ServletException, IOException {
		SubjectDto subjectDto = new SubjectDto();
